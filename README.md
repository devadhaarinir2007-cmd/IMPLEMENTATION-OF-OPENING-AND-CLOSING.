...
cv2.putText(image, 'DEVADHAARINI.R', (100, 250), font, 1, (255, 255, 255), 2, cv2.LINE_AA)
```
```
...
```
## Output:
<img width="688" height="570" alt="Screenshot 2026-09-13 150604" src="https://github.com/user-attachments/assets/7537113b-3df6-4e9d-98f3-5c8209ce86bd" />
<img width="757" height="562" alt="Screenshot 2026-09-13 150612" src="https://github.com/user-attachments/assets/a6e0ba1e-5afb-4435-afa4-3c547a48f2fd" />
